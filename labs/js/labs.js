    ...
    simplePagerTemplate: function (args){
      ...
      Manager.addWidget(new AjaxSolr.CurrentSearchWidget({
         ...
         field_translation: [
           ...
           ["uiMediaType_sm:1", "資料種別:本"],
           ["uiMediaType_sm:2", "資料種別:雑誌"],
           ["uiMediaType_sm:3", "資料種別:新聞"],
           ["uiMediaType_sm:4", "資料種別:電子資料"],
           ["uiMediaType_sm:5", "資料種別:博士論文"],
           ["uiMediaType_sm:6", "資料種別:地図"],
           ["uiMediaType_sm:7", "資料種別:録音資料"],
           ["uiMediaType_sm:8", "資料種別:映像資料"],
           ["uiMediaType_sm:9", "資料種別:規格・テクニカルレポート"],
           ["uiMediaType_sm", "資料種別"],
           ["issuedYear_sm", "刊行年"],
           ["publisher_sm", "出版者"],
           ["ndcFacet1_sm", "分類"],
