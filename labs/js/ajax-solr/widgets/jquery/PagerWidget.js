...
AjaxSolr.PagerWidget = AjaxSolr.AbstractWidget.extend(
   ...
   *   Defaults to " ".
   * @param {String} [attributes.limitPages]  Limit of Pages.
   */
  ...
  afterRequest: function () {
    ...
    if(!this.limit){
      ...
      var total   = Math.min(parseInt(this.manager.response.response.numFound), parseInt(this.limit));
    }
    ...
    if ( (!!this.limitPages) && this.totalPages > this.limitPages){
      this.totalPages = this.limitPages;
    }
