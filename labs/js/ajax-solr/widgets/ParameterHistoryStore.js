(function (callback) {
  if (typeof define === 'function' && define.amd) {
    define(['core/ParameterStore', 'history'], callback);
  }
  else {
    callback();
  }
})(function(ParametereStore, history) {
  /**
  ...
  AjaxSolr.ParameterHistoryStore = AjaxSolr.ParameterStore.extend(
    ...
    save: function () {
      ...
      history.pushState({ params: this.hash }, title, '?' + this.hash);
    },
    ...
    /**
     * Called when this.getTitleString is applied. Override this method if you want to change format of title.
     */
    ...
    /**
     * Return Title of current state. This method is called when this.save()
     */   
    getTitleString: function () {
      return this.changeTitleHandler.apply(this);
    },

  });

  return AjaxSolr.ParameterHistoryStore;
